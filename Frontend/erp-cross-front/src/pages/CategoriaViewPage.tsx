    ...
    <div className="page-container">
      ...
      <div className="page-header">
        <div className="page-title-area">
          ...
          <h1 className="page-title">Visualizar Categoria</h1>
        </div>
      </div>
        ...
        <div className="form-page">
          <div className="form-section">
            ...
            <div className="view-group">
              ...
              <span className="view-value">{categoria.nomeCategoria}</span>
            </div>

            <div className="view-group">
              <span className="view-label">Descrição</span>
              <span className="view-value">{categoria.descricao || '—'}</span>
            </div>
            ...
            <div className="form-row view-dates">
              <div className="view-group">
                ...
                <span className="view-value view-muted">{formatDate(categoria.dataCriacao)}</span>
              </div>
              <div className="view-group">
                <span className="view-label">Atualizado em</span>
                <span className="view-value view-muted">{formatDate(categoria.dataAtualizacao)}</span>
              </div>
            </div>
          </div>

          <div className="form-page-footer">
            <button className="btn-primary" onClick={() => navigate(`/categorias/editar/${categoria.id}`)}>
