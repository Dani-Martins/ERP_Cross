...
public class FormaPagamentoRepository
{
    ...
    {
        var sql = "SELECT Id, NomeFormaPagamento, AceitaParcela, Ativo, DataCriacao, DataAtualizacao FROM FormasPagamento";
    ...
    {
        const string sql = "SELECT Id, NomeFormaPagamento, AceitaParcela, Ativo, DataCriacao, DataAtualizacao FROM FormasPagamento WHERE Id = @Id";
    ...
    {
        const string sql = @"
            INSERT INTO FormasPagamento (NomeFormaPagamento, AceitaParcela, Ativo, DataCriacao, DataAtualizacao)
            VALUES (@NomeFormaPagamento, @AceitaParcela, @Ativo, NOW(), NOW());
    ...
    public async Task<bool> UpdateAsync(FormaPagamento forma)
    {
        const string sql = @"
            ...
            SET NomeFormaPagamento = @NomeFormaPagamento, AceitaParcela = @AceitaParcela, Ativo = @Ativo, DataAtualizacao = NOW()
            WHERE Id = @Id";
    ...
    {
        const string sql = "UPDATE FormasPagamento SET Ativo = 0, DataAtualizacao = NOW() WHERE Id = @Id";
