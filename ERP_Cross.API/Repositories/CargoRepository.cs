...
public class CargoRepository
{
    ...
    {
        var sql = "SELECT Id, NomeCargo, Setor, SalarioBase, ExigeCnh, Ativo, DataCriacao, DataAtualizacao FROM Cargos";
    ...
    {
        const string sql = "SELECT Id, NomeCargo, Setor, SalarioBase, ExigeCnh, Ativo, DataCriacao, DataAtualizacao FROM Cargos WHERE Id = @Id";
    ...
    {
        const string sql = @"
            INSERT INTO Cargos (NomeCargo, Setor, SalarioBase, ExigeCnh, Ativo, DataCriacao, DataAtualizacao)
            VALUES (@NomeCargo, @Setor, @SalarioBase, @ExigeCnh, @Ativo, NOW(), NOW());
    ...
    public async Task<bool> UpdateAsync(Cargo cargo)
    {
        const string sql = @"
            UPDATE Cargos 
            SET NomeCargo = @NomeCargo, Setor = @Setor, SalarioBase = @SalarioBase, 
